# This Makefile is for the Net::Rovio extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Net/Rovio.pm]
#     AUTHOR => q[ivantis <ivantis@>]
#     NAME => q[Net::Rovio]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/Net/Rovio.pm]
...
TO_INST_PM = lib/Net/Rovio.pm

PM_TO_BLIB = lib/Net/Rovio.pm \
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  lib/Net/Rovio.pm $(INST_MAN3DIR)/Net::Rovio.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:         Net-Rovio' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:      0.4' >> META_new.yml
	$(NOECHO) $(ECHO) 'version_from: lib/Net/Rovio.pm' >> META_new.yml
...
ppd:
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>A Perl module for Rovio manipulation</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>ivantis &lt;ivantis@&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' \
	  lib/Net/Rovio.pm blib/lib/Net/Rovio.pm 
